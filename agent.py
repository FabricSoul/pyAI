...
class Agent:
    ...
    def get_state(self, game):
        ...
        state = [
            ...
            # (direction_right and game.is_collision(point_right*1)) or
            # (direction_left and game.is_collision(point_left*1)) or
            # (direction_up and game.is_collision(point_up*1)) or
            # (direction_down and game.is_collision(point_down*1)),
